...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 08, 2025 at 04:47 AM
...
CREATE TABLE `claimed_items` (
  `id` int(10) NOT NULL,
  `claimer_id` int(10) DEFAULT NULL,
  `item_id` int(10) DEFAULT NULL,
  `found_id` int(10) DEFAULT NULL
...
CREATE TABLE `found` (
  `found_id` int(10) NOT NULL,
  `item_id` int(10) DEFAULT NULL,
  `room_no` varchar(50) DEFAULT NULL,
  `finder_id` int(10) DEFAULT NULL,
...
--
ALTER TABLE `claimer`
  MODIFY `claimer_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `finder`
--
ALTER TABLE `finder`
  MODIFY `finder_id` int(10) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `found`
--
ALTER TABLE `found`
  MODIFY `found_id` int(10) NOT NULL AUTO_INCREMENT;
